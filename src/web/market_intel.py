...
_COMPETITOR_INTEL: dict[str, dict[str, Any]] = {
    "Апартаменты Петровские": {
        ...
        "price_hint": "от ~2 590 ₽/сутки (мин. по объектам)",
        "engine": "Tilda + Bnovo",
        "parser_note": "Static HTML — объекты + диапазоны цен",
        "description": (
            "Прямой конкурент: каталог отдельных апартаментов. "
            "Цена «от» — минимум нижней границы диапазона по объектам "
            "(не пакет «3 суток» у загородного лота)."
        ),
        "strengths": [
...
GLOBAL_TRENDS: list[dict[str, str]] = [
    ...
    },
    {
        ...
        "body": (
            ...
            "Средний прирост RevPAR (доход на доступный номер) у внедривших — 8–15% (STR, 2025)."
        ),
        "tag": "Технологии",
    },
    {
    ...
    },
    {
        ...
        "body": (
            ...
            "Пакеты «рабочее место + поздний выезд» повышают ADR (среднюю цену номера за сутки)."
        ),
        "tag": "Продукт",
    },
]
...
IDEAS_FOR_1APART: list[dict[str, str]] = [
    ...
    },
    {
        ...
        "body": (
            "Сегмент «Уже проживали» в ГуглТабл — основа для "
